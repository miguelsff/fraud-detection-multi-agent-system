"""Threat intelligence port — ThreatProvider ABC and ThreatIntelPort Protocol."""

from abc import ABC, abstractmethod
from typing import Protocol

from app.domain.models import ThreatSource, Transaction, TransactionSignals

__all__ = ["ThreatProvider", "ThreatIntelPort"]
...
class ThreatIntelPort(Protocol):
    """Port for threat intelligence gathering.

    Wraps multiple ThreatProvider instances and provides a unified interface.
    """

    def get_providers(self) -> list[ThreatProvider]:
        """Return the list of enabled threat intelligence providers."""
        ...
